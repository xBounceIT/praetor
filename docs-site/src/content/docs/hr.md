...
Ogni scheda Competence Center separa i responsabili dal team, mostra il numero totale dei membri e mantiene sempre visibili le azioni disponibili. Le iniziali consentono di riconoscere rapidamente le persone: passa il mouse su un'iniziale per vederne il nome completo. Quando i membri superano lo spazio disponibile, un badge `+N` riassume i restanti e, al passaggio del mouse, ne elenca l'intera composizione senza dover aprire la scheda. Usa **Gestisci Manager** sotto la colonna dei responsabili per modificarne l'assegnazione nel dialog dedicato; il form di modifica del Competence Center aggiorna invece solo nome e descrizione. I responsabili sono ordinati stabilmente per nome e il loro ordine resta coerente tra la scheda e il dialog di gestione.
