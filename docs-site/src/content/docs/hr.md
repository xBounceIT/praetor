...
I permessi Competence Center senza ambito **All** restano limitati ai centri gestiti dall'utente: modifica, eliminazione e gestione dei membri richiedono che l'utente sia responsabile del centro. Durante la creazione o la modifica dei responsabili, l'utente deve mantenere sé stesso tra i responsabili e può aggiungere come ulteriori responsabili solo persone già comprese nel proprio ambito HR gestito. Il permesso **All** della singola azione abilita invece l'operazione trasversale.

Ogni scheda Competence Center separa i responsabili dal team, mostra il numero totale dei membri e mantiene sempre visibili le azioni disponibili. Responsabili e membri usano lo stesso gruppo compatto di avatar: passa il mouse su un'iniziale per vederne il nome completo. Quando le persone superano lo spazio disponibile, un badge `+N` riassume le restanti e, al passaggio del mouse, ne elenca l'intera composizione senza dover aprire la scheda. Usa **Gestisci Manager** sotto la colonna dei responsabili per modificarne l'assegnazione nel dialog dedicato; il form di modifica del Competence Center aggiorna invece solo nome e descrizione. I responsabili sono ordinati stabilmente per nome e il loro ordine resta coerente tra la scheda e il dialog di gestione.
