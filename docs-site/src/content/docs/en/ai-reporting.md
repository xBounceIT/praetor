...
- **Projects** — status, active/passive/internal type, client (Internal jobs use Praetor's configured company), dates, revenue, billing, optional linked documents, hours, and authorized costs.
