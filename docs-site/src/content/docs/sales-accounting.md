...
Lo **Stato** del preventivo cliente segue la pipeline **Bozza → Inviato → Offerta → Accettato / Rifiutato**. Lo stato **Scaduto** è derivato automaticamente dalla **Data Scadenza** (quando è passata) e ha la precedenza sullo stato visualizzato; un preventivo **Accettato** o **Rifiutato** non viene mai mostrato come Scaduto. Un preventivo può tornare in **Bozza** solo da **Inviato** o **Offerta**: da Accettato, Rifiutato o Scaduto la transizione non è consentita. Da Scaduto si esce solo estendendo la **Data Scadenza** (sempre modificabile), non cambiando manualmente lo stato.

Dal form del preventivo cliente puoi collegare un singolo **Preventivo Fornitore** (relazione 1-a-1) tramite il selettore **Preventivo Fornitore Collegato**. Se il preventivo fornitore collegato è **Scaduto**, il preventivo cliente mostra un indicatore e non può avanzare a **Inviato**, **Offerta** o **Accettato** finché non estendi la validità del preventivo fornitore.
...
Lo **Stato** del preventivo fornitore è interamente derivato e non può mai essere cambiato manualmente. Un preventivo fornitore non collegato è sempre in **Bozza** (ed è in questo stato che compare tra le opzioni nel form del preventivo cliente); una volta collegato a un preventivo cliente, lo stato segue quel documento: **Inviato** quando il preventivo cliente è inviato, **Offerta** quando dal preventivo nasce un'offerta cliente, **Accettato**/**Rifiutato** quando il preventivo o la sua offerta raggiungono uno stato terminale. Lo stato **Scaduto** compare quando passa la **Data Scadenza propria** del preventivo fornitore oppure quando scade il preventivo/l'offerta collegati. La **Data Scadenza** resta modificabile in qualsiasi stato per rinnovare la validità.
