...
Nella scheda **Personalizzazione**, gli amministratori personalizzano il nome e il logo dell'azienda. Il nome azienda sostituisce la scritta "PRAETOR" nell'intestazione della barra laterale, mentre l'etichetta di versione in basso resta "Praetor v..."; il logo caricato sostituisce sia l'icona nella barra laterale sia il logo della schermata di accesso. I logo accettano PNG, JPEG, WEBP o SVG fino a 2 MB; lasciando vuoto un campo si ripristina il valore predefinito di Praetor. La personalizzazione è leggibile pubblicamente affinché la schermata di accesso possa mostrarla prima dell'accesso, ma solo gli amministratori con il permesso di aggiornamento delle impostazioni generali possono modificarla.
