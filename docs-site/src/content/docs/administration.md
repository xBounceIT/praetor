...
Nella scheda **Personalizzazione**, gli amministratori personalizzano il nome e il logo dell'azienda. La barra laterale mantiene sempre la scritta "PRAETOR" come marchio prodotto e mostra il nome azienda nella riga secondaria sotto il marchio, al posto dell'etichetta ruolo/area di lavoro; l'etichetta di versione in basso resta "Praetor v...". Il logo caricato sostituisce sia l'icona nella barra laterale sia il logo della schermata di accesso. I logo accettano PNG, JPEG, WEBP o SVG fino a 2 MB; lasciando vuoto un campo si ripristina il valore predefinito di Praetor. La personalizzazione è leggibile pubblicamente affinché la schermata di accesso possa mostrarla prima dell'accesso, ma solo gli amministratori con il permesso di aggiornamento delle impostazioni generali possono modificarla.
