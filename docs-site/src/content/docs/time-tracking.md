...
Per ogni giorno feriale valido, Praetor prepara la bozza con **09:00** come entrata e **18:00** come uscita, anche quando non ci sono registrazioni tracciate. **Ore** e **PICAP** vengono ricalcolati dai valori modificabili di entrata e uscita, sottraendo la pausa pranzo configurata quando l'intervallo supera le sei ore. Le festività italiane che cadono tra lunedì e venerdì vengono marcate con `F`; le festività nel weekend non vengono marcate. Se almeno una registrazione del giorno non è `remote`, la riga viene indicata come **In sede**, altrimenti come **Telelavoro**.
