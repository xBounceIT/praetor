...
I filtri attivi restano associati alla singola tabella nel browser: se passi a un'altra sezione e poi torni, Praetor ripristina automaticamente la selezione. Nell'apertura normale, il pulsante **Rimuovi filtri** cancella sia i filtri visibili sia quelli memorizzati per quella tabella. I filtri ricevuti da un collegamento diretto hanno sempre la precedenza ma restano temporanei: rimuoverli dalla vista non sostituisce la selezione memorizzata nel browser.

La maniglia nell'intestazione permette di trascinare le colonne nella posizione desiderata; con la tastiera puoi usare le frecce sinistra e destra sulla stessa maniglia. Dal menu **Colonne** puoi anche mostrare o nascondere le colonne disponibili. Dopo una modifica manuale dell'ordine o della visibilità, il suggerimento **Salvare la vista personalizzata?** alla sinistra di **Esporta** apre il modale per creare una nuova vista personalizzata già impostata con la configurazione corrente. Puoi modificare l'ordine anche nell'elenco delle colonne quando aggiungi o modifichi una vista, trascinando la maniglia oppure usando le frecce su e giù. **Ripristina colonne** ripristina sia la visibilità sia l'ordine predefinito. Le modifiche manuali non salvate sono temporanee, mentre una vista con nome conserva e condivide visibilità e ordine delle colonne insieme a ordinamento dei dati e filtri.
...
Restano invece locali al browser, e quindi privati per ciascun dispositivo, le preferenze di sola visualizzazione come densità delle righe, dimensione del testo, larghezza delle colonne e quale vista è attiva. La dimensione del testo è una preferenza unica condivisa da tutte le tabelle comuni: modificarla in una vista la applica anche alle altre e ridimensiona in modo coerente anche i badge di stato.
