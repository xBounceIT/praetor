...
L'azione **Aggiungi Commessa** apre una finestra dedicata alla sola creazione: ordine cliente, cliente, nome, date, offerta facoltativa, tipo, consuntivazione, ricavo facoltativo e una tabella di attività iniziali. Al salvataggio sei portato direttamente alla pagina di dettaglio della nuova commessa.
...
- La sezione superiore dispone i campi della commessa orizzontalmente (ordine cliente, cliente, nome, descrizione, date, offerta, tipo, consuntivazione, ricavo, switch di disabilitazione) accanto alla tabella attività modificabile inline.
...
Quando una commessa termina, verifica che le attività siano coerenti e che non rimangano registrazioni pendenti.
