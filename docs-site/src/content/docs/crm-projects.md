...
L'azione **Aggiungi Commessa** apre una finestra dedicata alla sola creazione: ordine cliente, cliente, nome, date, offerta facoltativa, tipo, stato, consuntivazione, ricavo facoltativo e una tabella di attività iniziali. Al salvataggio, chi dispone del permesso sui dati avanzati viene portato alla pagina di dettaglio; gli altri ruoli restano nell'archivio.
