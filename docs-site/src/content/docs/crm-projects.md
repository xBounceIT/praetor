...
L'azione **Aggiungi Commessa** apre una finestra dedicata alla sola creazione. Il primo campo è **Tipo**: per una commessa **Attivo** o **Passivo** compili ordine cliente, cliente, nome, date, offerta facoltativa, stato, consuntivazione, ricavo facoltativo e attività iniziali; per una commessa **Interna** ordine e offerta sono nascosti, mentre il cliente resta obbligatorio. Al salvataggio sei portato direttamente alla pagina di dettaglio della nuova commessa.
