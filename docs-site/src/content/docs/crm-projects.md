...
- La sezione superiore dispone i campi del progetto orizzontalmente (cliente, nome, descrizione, date, offerta, tipo, consuntivazione, ricavo, switch di disabilitazione) accanto alla tabella attività modificabile inline.
