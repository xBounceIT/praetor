...
- Aggiunto warning per variabili critiche deboli (secret key etc.) nei log del backend
...
- RBAC 2.0: Profili personalizzati, profili multipli per utenti, permessi granulari, nuova pagina Ruoli nel modulo Amministrazione (stile glpi)
- Migrato da ESLint + Prettier a Biome (AIO 30x più performante in Rust)
- Aggiunto Redis come cache layer tra backend e DB
