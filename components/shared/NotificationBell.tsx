...
const NotificationBell: React.FC<NotificationBellProps> = ({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-xl border border-zinc-200 z-50 animate-in fade-in zoom-in-95 duration-200 origin-top-right overflow-hidden">
          {/* Header */}
          ...
          <div className="max-h-96 overflow-y-auto">
            {notifications.length === 0 ? (
              ...
              notifications.map((notification) => (
                <div
                  key={notification.id}
                  className={`px-4 py-3 border-b border-zinc-100 last:border-b-0 cursor-pointer transition-colors ${
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <p
                          className={`text-sm flex-1 ${
                            notification.isRead ? 'text-zinc-600' : 'text-zinc-800 font-medium'
                          }`}
                        >
                      ...
                      {notification.type === 'new_projects' &&
                        ...
                        notification.data.projectNames.length > 0 && (
                          ...
                          >
                            <ul className="text-xs text-zinc-500 space-y-1 pl-3 border-l-2 border-zinc-200">
