...
const toGeneralSettingsState = (genSettings: IGeneralSettings): GeneralSettingsState => ({
  ...
  localApiKey: genSettings.localApiKey || '',
  localBaseUrl: genSettings.localBaseUrl || '',
  ...
  localModelId: genSettings.localModelId || '',
...
const useAppContentController = () => {
  ...
  const applyGeneralSettingsUpdate = (updated: IGeneralSettings) => {
    setGeneralSettings({
      ...
      localApiKey: updated.localApiKey || '',
      ...
      localModelId: updated.localModelId || '',
