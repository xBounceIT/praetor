...
export const DEMO_EXPECTED_COUNTS = {
  ...
  // Non-draft quotes each get REV1 (= length-1); PREV #02 also gets showcase REV2.
  quote_revisions: DEMO_QUOTES.length,
  ...
  // Non-draft offers each get REV1 (= length-1); OFF #02 also gets showcase REV2.
  offer_revisions: DEMO_CUSTOMER_OFFERS.length,
  ...
  // Progressed supplier quotes each get REV1 (12); FORN #02 also gets showcase REV2.
  supplier_quote_revisions: 13,
