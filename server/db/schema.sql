...
-- Seed admin role with explicit non-configuration permissions
-- (configuration permissions come from is_admin flag automatically)
INSERT INTO role_permissions (role_id, permission) VALUES
    ('admin', 'timesheets.tracker.view'),
    ('admin', 'timesheets.tracker.create'),
    ('admin', 'timesheets.tracker.update'),
    ('admin', 'timesheets.tracker.delete'),
    ('admin', 'timesheets.recurring.view'),
    ('admin', 'timesheets.recurring.create'),
    ('admin', 'timesheets.recurring.update'),
    ('admin', 'timesheets.recurring.delete'),
    ('admin', 'timesheets.tracker_all.view'),
    ('admin', 'crm.clients.view'),
    ('admin', 'crm.clients.create'),
    ('admin', 'crm.clients.update'),
    ('admin', 'crm.clients.delete'),
    ('admin', 'crm.clients_all.view'),
    ('admin', 'crm.suppliers.view'),
    ('admin', 'crm.suppliers.create'),
    ('admin', 'crm.suppliers.update'),
    ('admin', 'crm.suppliers.delete'),
    ('admin', 'crm.suppliers_all.view'),
    ('admin', 'sales.client_quotes.view'),
    ('admin', 'sales.client_quotes.create'),
    ('admin', 'sales.client_quotes.update'),
    ('admin', 'sales.client_quotes.delete'),
    ('admin', 'catalog.internal_listing.view'),
    ('admin', 'catalog.internal_listing.create'),
    ('admin', 'catalog.internal_listing.update'),
    ('admin', 'catalog.internal_listing.delete'),
    ('admin', 'catalog.external_listing.view'),
    ('admin', 'catalog.external_listing.create'),
    ('admin', 'catalog.external_listing.update'),
    ('admin', 'catalog.external_listing.delete'),
    ('admin', 'catalog.special_bids.view'),
    ('admin', 'catalog.special_bids.create'),
    ('admin', 'catalog.special_bids.update'),
    ('admin', 'catalog.special_bids.delete'),
    ('admin', 'accounting.clients_orders.view'),
    ('admin', 'accounting.clients_orders.create'),
    ('admin', 'accounting.clients_orders.update'),
    ('admin', 'accounting.clients_orders.delete'),
    ('admin', 'accounting.clients_invoices.view'),
    ('admin', 'accounting.clients_invoices.create'),
    ('admin', 'accounting.clients_invoices.update'),
    ('admin', 'accounting.clients_invoices.delete'),
    ('admin', 'finances.payments.view'),
    ('admin', 'finances.payments.create'),
    ('admin', 'finances.payments.update'),
    ('admin', 'finances.payments.delete'),
    ('admin', 'finances.expenses.view'),
    ('admin', 'finances.expenses.create'),
    ('admin', 'finances.expenses.update'),
    ('admin', 'finances.expenses.delete'),
    ('admin', 'projects.manage.view'),
    ('admin', 'projects.manage.create'),
    ('admin', 'projects.manage.update'),
    ('admin', 'projects.manage.delete'),
    ('admin', 'projects.manage_all.view'),
    ('admin', 'projects.tasks.view'),
    ('admin', 'projects.tasks.create'),
    ('admin', 'projects.tasks.update'),
    ('admin', 'projects.tasks.delete'),
    ('admin', 'projects.tasks_all.view'),
    ('admin', 'suppliers.quotes.view'),
    ('admin', 'suppliers.quotes.create'),
    ('admin', 'suppliers.quotes.update'),
    ('admin', 'suppliers.quotes.delete'),
    ('admin', 'hr.internal.view'),
    ('admin', 'hr.internal.create'),
    ('admin', 'hr.internal.update'),
    ('admin', 'hr.internal.delete'),
    ('admin', 'hr.external.view'),
    ('admin', 'hr.external.create'),
    ('admin', 'hr.external.update'),
    ('admin', 'hr.external.delete'),
    ('admin', 'settings.view'),
    ('admin', 'settings.update'),
    ('admin', 'docs.api.view'),
    ('admin', 'docs.frontend.view'),
