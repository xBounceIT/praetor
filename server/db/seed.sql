...
FROM (
    VALUES
        ...
        ('dm_sqi_12', 'dm_sq_12', 'dm_prd_06', 80.00, 182.00, 0.00, 'Accepted quote feeding the confirmed licensing order'),
        ...
        ('dm_sqi_15', 'dm_sq_14', 'dm_prd_05', 2.00, 965.00, 0.00, 'Accepted quote feeding the denied supplier order')
...
INSERT INTO supplier_sales (
    ...
    ('dm_ss_03', 'dm_sq_12', 'dm_sup_02', 'CloudSeat Licensing', '45gg', 0.00, 'confirmed', 'Confirmed supplier order generated from an accepted licensing quote and intentionally left without an invoice.', CURRENT_TIMESTAMP - INTERVAL '27 days', CURRENT_TIMESTAMP - INTERVAL '24 days'),
    ('dm_ss_04', 'dm_sq_13', 'dm_sup_03', 'SecureEdge Systems', '60gg', 0.00, 'confirmed', 'Confirmed supplier order generated from an accepted security quote and already invoiced.', CURRENT_TIMESTAMP - INTERVAL '20 days', CURRENT_TIMESTAMP - INTERVAL '17 days'),
    ('dm_ss_05', 'dm_sq_14', 'dm_sup_01', 'TechSource Distribution', '30gg', 0.00, 'denied', 'Denied supplier order generated from an accepted quote for history coverage.', CURRENT_TIMESTAMP - INTERVAL '15 days', CURRENT_TIMESTAMP - INTERVAL '13 days')
ON CONFLICT (id) DO UPDATE SET
    linked_quote_id = EXCLUDED.linked_quote_id,
    supplier_id = EXCLUDED.supplier_id,
    supplier_name = EXCLUDED.supplier_name,
