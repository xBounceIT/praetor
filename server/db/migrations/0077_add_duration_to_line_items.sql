...
ALTER TABLE "quote_items" ADD CONSTRAINT "chk_quote_items_duration_months" CHECK ("quote_items"."duration_months" >= 1);--> statement-breakpoint
...
ALTER TABLE "sale_items" ADD CONSTRAINT "chk_sale_items_duration_months" CHECK ("sale_items"."duration_months" >= 1);--> statement-breakpoint
