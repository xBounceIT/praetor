...
const MIGRATION = readMigrationFile('0071_add_ril_drafts_and_weekday_transfer.sql');

describe('migration 0071: adds RIL drafts table and weekday transfer defaults', () => {
